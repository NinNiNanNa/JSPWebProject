...
public class BoardPage {
    ...
    public static String pagingStr(int totalCount, int pageSize, int blockPage,
        ...
        */
         ...
         */
        if (pageTemp != 1) {
            pagingStr += "<li><a href='" + reqUrl + "&pageNum=1'>◀</a></li>";            
        ...
        while (blockCount <= blockPage && pageTemp <= totalPages) {
            ...
            if (pageTemp == pageNum) {
                pagingStr += "<li><a href='#' class='active'>" + pageTemp + "</a></li>";
            } else {
    ...
    public static String pagingImg(int totalCount, int pageSize, int blockPage,
        ...
        */
         ...
         */
        if (pageTemp != 1) {
            pagingStr += "<li><a href='" + reqUrl + "&pageNum=1'><img src='../images/paging1.gif'></a></li>";            
            pagingStr += "<li><a href='" + reqUrl + "&pageNum=" + (pageTemp - 1)
                         + "'><img src='../images/paging2.gif'></a></li>";
        }
        ...
        if (pageTemp <= totalPages) {
            pagingStr += "<li><a href='" + reqUrl + "&pageNum=" + pageTemp
                         + "'><img src='../images/paging3.gif'></a></li>";
            pagingStr += "<li><a href='" + reqUrl + "&pageNum=" + totalPages
                         + "'><img src='../images/paging4.gif'></a></li>";
        }
